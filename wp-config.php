...
define( 'WPCACHEHOME', '/home/c2750116/public_html/wp-content/plugins/wp-super-cache/' );
$sDestDir = '/home/c2750116/public_html';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'c2750116_wordpre');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'c2750116_wordpre');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'fnpyvcp1Zkmrdmt');
