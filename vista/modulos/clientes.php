...
<div class="row">
  ...
  <div class="col-sm-4 offset-2">
      <a href="<?= RUTA_URL ?>crearUsuario" class="btn btn-success w-100"><i class="bi bi-plus-circle-fill"></i> Nuevo Cliente</a>
    </div>
</div>
          ...
          foreach ($clientes as $cliente): ?>
            <tr>
              ...
              <td>
                ...
                <a href="<?=RUTA_URL?>clientes/eliminar/<?php echo $cliente['ID_Cliente']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar este cliente?')">Eliminar</a>
              </td>
            </tr>
          <?php endforeach; ?>
