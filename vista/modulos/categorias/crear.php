...
<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            <form id="formCategoria" method="POST" action="<?php echo RUTA_URL; ?>categorias/guardar" class="card form-card">
                <?php 
                ...
                <div class="form-header d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="mb-0 fw-bold"><i class="bi bi-plus-circle me-2"></i> Nueva Categoría</h3>
                        <p class="mb-0 opacity-75 small">Crea una nueva categoría o subcategoría</p>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" required 
                                   maxlength="100" placeholder="Ej: Electrónica, Alimentos, Ropa...">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3"
                                      placeholder="Describe brevemente el tipo de productos que incluye..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-7">
                            ...
                            <div class="form-text"><i class="bi bi-arrow-return-right"></i> Selecciona si esta categoría pertenece a otra.</div>
                        </div>
