...
try {
    ...
    require_once __DIR__ . '/../utils/responder.php'; // Added responder utility
    ...
    $esProveedor = isProveedorCRM($userId) && (int)$lead['proveedor_id'] === $userId;
    $esCliente = isClienteCRM($userId) && (int)$lead['cliente_id'] === $userId;
